                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('safeguards.destroy',$safeguard->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary ver" data-url="{{ route('safeguards.show',$safeguard->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('safeguards.edit',$safeguard->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
